...
function liquidar(){
    ...
    //
    let totaldevo=document.getElementById("totaldevo").value;
    //SECCION DE LIQUIDACION DE DEDUCCIONES
    //EPS Y PENSION
    let eps00=(totaltdevo-subsidiot)*0.04; //EPS EMPLEADO
    let pen00=(totaltdevo-subsidiot)*0.04; //PENSION EMPLEADO
